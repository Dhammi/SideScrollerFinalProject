...
var states;
(function (states) {
    // GAME PLAY 3 OVER STATE CLASS
    var GamePlay3Over = (function () {
        // CONSTRUCTOR ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        function GamePlay3Over() {
            this.tryAgain = false;
        ...
        GamePlay3Over.prototype.tryAgainClicked = function () {
            this.tryAgain = true;
        };
        // PUBLIC METHODS +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        GamePlay3Over.prototype.update = function () {
            this.ocean.update();
            if (this.tryAgain) {
        ...
        return GamePlay3Over;
    })();
    states.GamePlay3Over = GamePlay3Over; // Game Over Class
})(states || (states = {})); // States Module   
//# sourceMappingURL=gamePlay3Over.js.map